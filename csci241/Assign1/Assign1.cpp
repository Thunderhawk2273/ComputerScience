...
/*
 Program fails to loop
        - can calculate most people's names

WAS CREATED ON Xcode
 */
...
void gettingTheWorkDone(string);                                // Main function
...
/***************************************************************
 ...
 Returns: none
 ***************************************************************/
void gettingTheWorkDone(string namechange)
{
    int i, sum;
    ...
    strcpy(namearray, namechange.c_str());     // Copies the C++ string into the a$
